...
public class ReleaseWS {
  public static final String PROP_BUILD_DATE = "enterprises.orbital.evemail.build";
  public static final String PROP_VERSION    = "enterprises.orbital.evemail.version";
